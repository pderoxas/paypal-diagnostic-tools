...
public enum SdkClient {
    ...
    // Response Time Lists
    public List<Long> getLocationElapsedTimes = new ArrayList<>();
    public List<Long> setLocationAvailabilityElapsedTimes = new ArrayList<>();
    ...
    public void initialize() {
        logger.debug("Initializing SdkClient Singleton...");
    }
